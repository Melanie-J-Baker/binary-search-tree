...
Write a buildTree function which takes an array of data and turns it into a balanced binary tree full of Node objects appropriately placed (don’t forget to sort and remove duplicates!). The buildTree function should return the level-0 root node.
...
Tie it all together - Write a simple driver script that does the following:
