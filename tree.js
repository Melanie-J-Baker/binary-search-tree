...
export default class Tree {
    ...
    // isBalanced function which checks if tree is balanced (difference between heights of left/right subtree of every node is not more than 1)
